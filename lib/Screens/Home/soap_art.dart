...
class SoapArt extends StatefulWidget {
  const SoapArt({super.key});

  @override
  State<SoapArt> createState() => _SoapArtState();
}

class _SoapArtState extends State<SoapArt> {

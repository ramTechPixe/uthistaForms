...
class PotteryClay extends StatefulWidget {
  const PotteryClay({super.key});

  @override
  State<PotteryClay> createState() => _PotteryClayState();
}

class _PotteryClayState extends State<PotteryClay> {
                          ...
                          () => dashboardcontroller.addFormLoading == true
                              ...
                              : CustomButton(
                                  ...
                                  onTap: () {
                                    ...
                                    var payload = {
                                      'formType': "potteryclayartworkshop",
